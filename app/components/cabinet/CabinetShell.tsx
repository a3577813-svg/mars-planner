 ...
 return <main className="cabinetShell">
  ...
  <section className="cabinetMain">
   <header className="cabinetTopbar">
    ...
    <div className="cabinetUser"><span className="cabinetSearch">⌕</span><button className="cabinetGrade">♧&nbsp; {gradeLabel}</button><span className="cabinetAvatar">{firstName.slice(0,1)}</span><b>{studentName}</b><button type="button" className="cabinetLogout" onClick={logout}>Выйти</button></div>
   </header>
