...
const CUSTOM_OPTION_RE = /^(свой способ|свой вариант|своя цель|другое|другой вариант|другая роль|новая роль)/i;
...
export default function CustomCheckboxFields(){
  ...
  return <style jsx global>{`
    ...
    @media(max-width:650px){.customCheckboxText{flex-basis:100%;margin-left:25px}}
  `}</style>;
}
