...
export default function StudentDashboard(){
 ...
 useEffect(()=>{
  const refresh=()=>{
   ...
   setCurrentPage(Math.min(6,Math.max(1,saved||1)));
  };
 ...
 return <main className="studentCabinet">
  ...
  <section className="cabinetMain">
   <div className="hero">
    ...
    <div className="progress"><div className="ring" style={{background:`conic-gradient(#ff6547 ${Math.max(spreadProgress,3)}%,#ffffff2d 0)`}}><strong>{currentPage}</strong><span>из 33</span></div><b>Текущий разворот</b><small>{current.title}</small></div>
   </div>

   <div className="dashboardGrid">
    <section className="routeCard">
     <div className="cardTitle"><div><p className="eyebrow">ПЛАНЁРКА</p><h2>Мой маршрут</h2></div><span>Доступно 6 разворотов</span></div>
